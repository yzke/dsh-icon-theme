...
The test fixture transcribes only public registration metadata from these pinned revisions. None of the projects is required or installed by the test. This deliberately exercises the public slot contract rather than adapting to one local profile.
