export const zh = {
  ...
  originalPolicy: '原图标策略',
  preferOriginal: '保留原图标',
  preferOriginalHint: '优先保留插件原图标',
  replaceGeneric: '替换回退',
  replaceGenericHint: '替换通用回退图标',
  officialMark: '官方',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  originalPolicy: 'Original icon policy',
  preferOriginal: 'Keep originals',
  preferOriginalHint: 'Prefer plugin originals',
  replaceGeneric: 'Replace fallbacks',
  replaceGenericHint: 'Replace generic fallbacks',
